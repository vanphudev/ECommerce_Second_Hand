...
import Address from "../../pages/pageDetailOrder/components/address/address";
...
const MembershipPolicy = React.lazy(() =>
  import("../../pages/pageMembershipPolicy")
);
const PaymentPolicy = React.lazy(() => import("../../pages/pagePaymentPolicy"));
const BuyingGuide = React.lazy(() => import("../../pages/pageBuyingGuide"));
const PersonalInformationSecurity = React.lazy(() =>
  import("../../pages/pagePersonalInformationSecurity")
);
const GiftOfGratitude = React.lazy(() =>
  import("../../pages/pageGiftOfGratitude")
);
///
...
const ResetPasswordForm = React.lazy(() =>
  import("../../pages/pageResetPassword/pageResetPassword")
);
...
const URL_LANDING = import.meta.env
  .VITE_ROUTER_MODULES_CUSTOMER_SITE_LANDING_DEFAULT;
const URL_MembershipPolicy = import.meta.env
  .VITE_ROUTER_MODULES_CUSTOMER_SITE_MembershipPolicy;
const URL_PaymentPolicy = import.meta.env
  .VITE_ROUTER_MODULES_CUSTOMER_SITE_PaymentPolicy;
const URL_BuyingGuide = import.meta.env
  .VITE_ROUTER_MODULES_CUSTOMER_SITE_BuyingGuide;
const URL_PersonalInformationSecurity = import.meta.env
  .VITE_ROUTER_MODULES_CUSTOMER_SITE_PersonalInformationSecurity;
const URL_GiftOfGratitude = import.meta.env
  .VITE_ROUTER_MODULES_CUSTOMER_SITE_GiftOfGratitude;
...
const URL_PROFILE_ADDRESS = import.meta.env
  .VITE_ROUTER_MODULES_CUSTOMER_SITE_PROFILE_ADDRESS;
const URL_PROFILE_INFORMATION = import.meta.env
  .VITE_ROUTER_MODULES_CUSTOMER_SITE_PROFILE_INFORMATION;
const URL_CART = import.meta.env.VITE_ROUTER_MODULES_CUSTOMER_SITE_CART;
const URL_DETAIL_ORDER = import.meta.env
  .VITE_ROUTER_MODULES_CUSTOMER_SITE_DETAIL_ORDER;
const URL_PROFILE_PAYMENT = import.meta.env
  .VITE_ROUTER_MODULES_CUSTOMER_SITE_PROFILE_PAYMENT;
...
const URL_PROFILE_RESET_PASSWORD = import.meta.env
        ...
        children: [
          ...
          },
          {
            ...
            element: (
              <Suspense
                fallback={
                  <Spin size="large" fullscreen style={{ zIndex: 10000 }} />
                }
              >
                <Payment />
              </Suspense>
