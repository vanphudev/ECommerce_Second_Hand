                  ...
                  <div className='membership-row'>
                     <div className='membership-col-12'>
                        ...
                        <div className='membership-content-page membership-rte'>
                           ...
                           <p>
                              Điều kiện cấp thẻ thành viên: Khi khách hàng mua hàng trên hệ thống nhà hàng Dola
                              Restaurant sẽ được cấp thẻ thành viên.
                           </p>
                           <p>
                           ...
                           <p>
                              <strong>Lưu ý:&nbsp;</strong>Hạn mức 10, 20, 30, 50, 100 triệu đồng là tính từ thời điểm
                              bắt đầu mua tới khi lên thẻ. Khi lên thẻ VIP và tích tiếp lên 20 đến 100 triệu, tổng tiền
