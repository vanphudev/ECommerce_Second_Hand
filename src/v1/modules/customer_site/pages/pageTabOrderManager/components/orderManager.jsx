      ...
      <div className='OrderManager'>
         <div className='TabOrderManager'>
            <div span={18} className='Content'>
               <Row>
                  <MenuTitle name={"ĐƠN MUA CỦA BẠN"} />
               </Row>
               <Row className='TabTrangThai'>
                  <Col span={4}>
                     <p className={active == 0 && "active"} onClick={() => setActive(0)}>
                        Tất Cả
                     </p>
                  </Col>
                  <Col span={4}>
                  ...
                  <Col span={4}>
                     <p className={active == 4 && "active"} onClick={() => setActive(4)}>
                        Hoàn tất
                     </p>
                  </Col>
                  <Col span={4}>
                     <p className={active == 5 && "active"} onClick={() => setActive(5)}>
                        Đã hủy
                     </p>
                  </Col>
               </Row>
