...
import "./style.scss";
import { IoWalletOutline, IoStar, IoChatbubbleEllipsesOutline } from "react-icons/io5";
         ...
         <div className="main tws-mt-20">
            ...
            <div className="Support tws-w-full tws-pt-[130px] tws-h-[700px]">
               <div className="support-container container ">
                  <h1 className="h1 tws-mx-auto tws-bg-[#55018d]  tws-w-[650px] tws-h-[80px] tws-flex tws-items-center tws-justify-center tws-rounded-[10px] tws-shadow-[0px_7px_8px_#767676] tws-text-4xl">
            ...
            <div className="Register tws-w-full  tws-flex tws-flex-col tws-justify-center tws-items-center tws-text-center">
               <div className="">
                  ...
                  <Link to={import.meta.env.VITE_ROUTER_MODULES_CUSTOMER_SITE_LOGIN}><Button title="Đăng ký" /></Link>
               </div>
            </div>
         </div>
      </>
