    ...
    <>
      <div className="main tws-mt-20">
        ...
        <div className="KhamPha container tws-w-full tws-h-[700px]">
          <div className="KhamPha_content"><div className="KhamPha_Text tws-text-center tws-text-3xl ">Khám phá ngay!</div>
              ...
              <Col span={14} className="Col2 ">
                <div className="Image">
                  <div className="image_1 tws-w-[360px] tws-h-[360px]">
                    <p className="tws-absolute tws-top-[17%] tws-left-[9%] tws-text-center">Kiểm tra <br />nghiêm</p>
                  </div>
                  <div className="image_2 tws-absolute tws-top-0 tws-left-[61%] tws-w-[260px] tws-h-[190px]">
                    <p className="tws-absolute tws-top-[60%] tws-left-[10%] tws-text-[25px]">Miễn phí<br /> vận chuyển</p>
                  </div>
                  <div className="image_3 tws-absolute tws-top-[35%] tws-left-[56%] tws-w-[160px] tws-h-[150px]">
                    <p className="tws-absolute tws-top-[65%] tws-left-[10%] tws-text-[18px]">Vận chuyển<br /> nhanh chóng</p>
                  </div>
                  ...
                  <div className="image_5 tws-absolute tws-top-[63%] tws-left-[45%] tws-w-[370px] tws-h-[230px]">
                    <p className="tws-absolute tws-top-[80%] tws-left-[10%] tws-text-[30px]">Giao hàng tận nơi</p>
                  </div>
                </div>
              </Col>
            </Row>
        ...
        <div className="Feedback tws-w-full">
          <Row >
            <Col span={12} className="Feedback_Col1 Center tws-h-[700px]  tws-w-full">
              <Image className="feedback-image tws-rounded-[30px] tws-max-w-full"
              ...
              <div className="Avatar tws-absolute tws-bottom-[12%] tws-left-[22%]">
                <img className="tws-w-[120px] tws-h-[120px] tws-rounded-full tws-border tws-border-white" src="src/v1/modules/customer_site/pages/pageLanding/assets/images/avatar.jpg" alt="" />
              </div>
        ...
        <div className="Support tws-w-full tws-pt-[130px] tws-h-[700px]">
          <div className="support-container container ">
            <h1 className="tws-mx-auto tws-bg-[#55018d] tws-text-white tws-w-[650px] tws-h-[80px] tws-flex tws-items-center tws-justify-center tws-rounded-[10px] tws-shadow-[0px_7px_8px_#767676] tws-text-4xl">KÊNH HỖ TRỢ NHÀ BÁN HÀNG</h1>
