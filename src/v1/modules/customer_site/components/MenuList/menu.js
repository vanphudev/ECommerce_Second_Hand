...
const Icon5 = () => <div className='icon_color tws-bg-orange tws-w-[32px]'></div>;
...
const items = [
   ...
   },
   {
      ...
      path: import.meta.env.VITE_ROUTER_MODULES_CUSTOMER_SITE_PROFILE_RESET_PASSWORD,
   },
   {
      key: "7",
...
const MenuDO = () => {
   ...
   const selectedKey = items.find((item) => item.path === location.pathname)?.key || "1";
